...
echo "==================="
echo ""
echo "Scope rules (13 templates total):"
echo "  🌐 GLOBAL  (claude mcp add -s user)  — generic tools used everywhere"
echo "             filesystem, github, puppeteer, slack, notion, linear"
echo "  📁 PROJECT (./.mcp.json)             — project-specific credentials"
echo "             postgres, mssql, mssql-dab, sentry, redis, jira, postman, custom APIs"
echo ""
